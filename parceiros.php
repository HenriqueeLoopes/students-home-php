...
<head>
    ...
    <title>Student's Home - Parceiros</title>
  ...
  <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\">
    ...
    <div class="container align-content-center">
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="card-body">
                    <img src="images/parceiros.jpg" class="img-thumbnail">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-4 box-shadow">
                    ...
                    <div class="card-body">
                        <H4><?php echo $TituloParceiro1; ?></H4>
                        <p class="card-text"><?php echo $DescricaoParceiro1; ?></p>
                        <br><br>
                        <a href="<?php echo $LinkParceiro1; ?>" class="btn btn-outline-dark">Veja mais...</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card mb-4 box-shadow">
                    <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Card image cap">
                    <div class="card-body">
                        <H4><?php echo $TituloParceiro2; ?></H4>
                        <p class="card-text"><?php echo $DescricaoParceiro2; ?></p>
                        <a href="<?php echo $LinkParceiro2; ?>" class="btn btn-outline-dark">Veja mais...</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card mb-4 box-shadow">
                    <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Card image cap">
                    <div class="card-body">
                        <H4><?php echo $TituloParceiro3; ?></H4>
                        <p class="card-text"><?php echo $DescricaoParceiro3; ?></p>
                        <br><br><br>
                        <a href="<?php echo $LinkParceiro3; ?>" class="btn btn-outline-dark">Veja mais...</a>
                    </div>
                </div>
            </div>
        </div>
