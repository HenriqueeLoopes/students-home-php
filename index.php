...
<head>
    ...
    <title>Student's Home - Inicio</title>
...
<body>
  ...
  <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\">
    ...
    <div class="jumbotron">
        <h2 class="display-4 text-center"><?php echo $TituloIndex; ?></h2>
        <p class="lead text-center"><?php echo $TextoIndex; ?></p>
        <p class="lead text-center">
            <a class="btn btn-outline-dark" href="hospedagem.php" role="button"><?php echo $BotaoIndex; ?></a>
        </p>
    </div>
    <br><br><br><br>
