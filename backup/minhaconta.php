    ...
    <div class="row">
        <div class="col-md-3 ">
            <div class="list-group text-center">
                <a href="#" class="list-group-item list-group-item-action active">Minha Conta</a>
                <a href="meuspontos.php" class="list-group-item list-group-item-action">Meus Pontos</a>
            </div>
        </div>
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Atualize seu perfil - <?php echo $_SESSION['nome']?></h4>
                            <hr>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <form action="atualizar.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="nome" name="nome" placeholder="Ex: João" class="form-control here" value="<?php echo $nome; ?>" required type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="sobrenome" class="col-4 col-form-label">Sobrenome:*</label>
                                    <div class="col-8">
                                        <input id="sobrenome" name="sobrenome" placeholder="Ex: Mendes" class="form-control here" value="<?php $linhas['sobrenome']; ?>" required type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="col-4 col-form-label">E-mail:*</label>
                                    <div class="col-8">
                                        <input id="email" name="email" placeholder="abc@abc.com" class="form-control here" required type="email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="cpf" class="col-4 col-form-label">CPF:*</label>
                                    <div class="col-8">
                                        <input id="cpf" name="cpf" placeholder="000.000.000-00" class="form-control here" required type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="rg" class="col-4 col-form-label">RG:*</label>
                                    <div class="col-8">
                                        <input id="rg" name="rg" placeholder="00.000.000-0" class="form-control here" required type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="telefone" class="col-4 col-form-label">Telefone ou Celular:*</label>
                                    <div class="col-8">
                                        <input id="telefone" name="telefone" placeholder="(00) 0.0000-0000" class="form-control here" required type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="datanasc" class="col-4 col-form-label">Email*</label>
                                    <div class="col-8">
                                        <input id="datanasc" name="datanasc" placeholder="00/00/0000" class="form-control here" required type="date">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="select" class="col-4 col-form-label">Estado:*</label>
                                    <div class="col-8">
                                        <select id="select" name="select" class="custom-select">
                                            <?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="cidade" name="cidade" placeholder="Ex: São Paulo" class="form-control here" required type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="endereco" class="col-4 col-form-label">Endereço:*</label>
                                    <div class="col-8">
                                        <input id="endereco" name="endereco" placeholder="Ex: Avenida Paulista, 1300, São Paulo, Brasil" class="form-control here" type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="senha" class="col-4 col-form-label">Nova Senha*</label>
                                    <div class="col-8">
                                        <input id="senha" name="senha" placeholder="********" class="form-control here" type="password">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="confirmarsenha" class="col-4 col-form-label">Confirmar Nova Senha*</label>
                                    <div class="col-8">
                                        <input id="confirmarsenha" name="confirmarsenha" placeholder="********" class="form-control here" type="password">
                                    </div>
                                </div>
                                <div class="form-group row">
