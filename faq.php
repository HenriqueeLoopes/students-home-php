...
<head>
    ...
    <title>Student's Home - FAQ</title>
                                ...
                                <div class="card-header" id="headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-dark" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            <?php echo $TituloPergunta1; ?>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <?php echo $RespostaPergunta1; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link collapsed text-dark" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                            <?php echo $TituloPergunta2; ?>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                    <div class="card-body">
                                        <?php echo $RespostaPergunta2; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link collapsed text-dark" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            <?php echo $TituloPergunta3; ?>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                    <div class="card-body">
                                        <?php echo $RespostaPergunta3; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="outras">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link collapsed text-dark" data-toggle="collapse" data-target="#outrascollapse" aria-expanded="false" aria-controls="outrascollapse">
                                            <?php echo $TituloPergunta4; ?>
                                        </button>
                                    </h5>
                                </div>
                                <div id="outrascollapse" class="collapse" aria-labelledby="outras" data-parent="#accordion">
                                    <div class="card-body">
                                        <a class="text-success" href="faleconosco.php"><?php echo $RespostaPergunta4; ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
